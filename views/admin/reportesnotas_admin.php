...
<head>
    ...
    <title>Reportes de Notas | Sistema de Gestión UEBF</title>
...
<body>
    ...
    ?>
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">aqui podra buscar , visualizar, y descargar el reporte de las calificaciones de todo un curso , de un estudiante espesifico </h1>
                </div>
